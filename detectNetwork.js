...
var detectNetwork = function(cardNumber) {
  ...
  function isSwitch() {
    if (prefix(4) === 4903 || prefix(4) === 4905 || prefix(4) === 4936 || prefix(6) === 564182 || prefix(6) === 633110 || prefix(4) === 6333 || prefix(4) === 6759) {
      return true;
    } else {
      return false;
    };
  ...
  } else if ((cardLen === 16 || cardLen === 18 || cardLen == 19) && isSwitch()) {
    return 'Switch';
  };
};
